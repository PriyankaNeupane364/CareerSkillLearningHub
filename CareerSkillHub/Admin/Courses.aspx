<%@ Page Title="Manage Courses" Language="C#" MasterPageFile="~/Masterpages/Site.Master"
    AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="CareerSkillHub.Admin.Courses" %>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="rfvInstructor" runat="server" ControlToValidate="ddlInstructor"
                    InitialValue="0" CssClass="field-error" Display="Dynamic" ErrorMessage="Select an instructor." />
            </div>
